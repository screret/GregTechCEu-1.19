...
public class GTBlocks {
    ...
    public static final BlockEntry<Block> CASING_ALUMINIUM_AEROSPACE = createCasingBlock("aluminium_aerospace", GTCEu.id("block/casings/solid/machine_casing_aerospace"));
